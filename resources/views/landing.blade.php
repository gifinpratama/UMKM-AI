    ...
    <section class="flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div class="relative z-9 max-w-7xl mx-auto px-6 text-center">
            ...
            <div id="hero-preview" class="relative max-w-5xl mx-auto opacity-0">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div class="col-span-2 stat-card p-3 h-32 flex items-end">
                                <div class="flex items-end gap-1 w-full">
                                    @for($i = 0; $i < 20; $i++)
                                        <div class="chart-bar flex-1 bg-gradient-to-t from-indigo-600 to-indigo-400 rounded-t"
                            ...
                            <div class="stat-card p-3">
                                ...
                                <p class="text-xs text-dark-300 leading-relaxed">"Penjualan meningkat 12.5% bulan ini.
                                    Produk 'Kopi Arabika' terlaris dengan margin tertinggi."</p>
                                <div class="mt-2 flex items-center gap-1">
                                    <div
                                        class="w-4 h-4 rounded bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
                ...
                <div
                    class="absolute -bottom-20 left-1/2 -translate-x-1/2 w-3/4 h-40 bg-indigo-600/20 blur-[80px] rounded-full">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="stats" class="relative py-24">
        <div class="max-w-7xl mx-auto px-6">
            <div class="glass-card p-12 text-center">
                <h2 class="text-3xl md:text-4xl font-bold text-white mb-12 stat-section-animate">Dipercaya oleh UMKM di
    ...
    <footer class="border-t border-white/5 py-12">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="border-t border-white/5 pt-8 text-center">
                <p class="text-xs text-dark-600">&copy; {{ date('Y') }} UMKM.AI. All rights reserved. Dibuat dengan ❤️ untuk
                    UMKM Indonesia.</p>
            </div>
        </div>
    </footer>
